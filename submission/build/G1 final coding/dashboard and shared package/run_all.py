    ...
    return [
        ...
        Stage(
            ...
            commands=[[
                ...
                #
                # Cell 13 stays in: it defines the `save(fig, tag)` figure
                # helper that cell 41 calls on its last line. Skipping it cost
                # a 75-minute search run to a NameError at the point of writing
                # the plot. It is pure matplotlib and costs milliseconds.
                "--skip", "12", "14", "15", "16", "31", "32", "34", "35",
                "36", "38", "39",
            ]],
        ),
        Stage(
