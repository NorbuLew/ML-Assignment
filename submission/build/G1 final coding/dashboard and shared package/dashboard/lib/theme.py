...
AGENT_ALIASES = {
    ...
    # tools/learning_curves.py writes agent names uppercased. DQN, DDQN and PPO
    # survive that unchanged; LinUCB is the one name with interior lowercase, so
    # it is the one that silently fell out of every colour scale keyed on
    # AGENT_ORDER.
    "LINUCB": "LinUCB",
}
